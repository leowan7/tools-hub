...
def test_handoff_pilot_preset_runs_standalone_not_smoke(
    ...
    # handoff (batch is only opted into explicitly by the user). Note:
    # the app sets pre_fill['preset']='pilot' on cross-tool handoffs as
    # a legacy default, but the template normalises any non-recognised
    # value back to 'standalone'.
    import re
